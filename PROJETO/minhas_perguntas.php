...
$query = "
    ...
    LEFT JOIN usuarios criador ON p.usuario_codigo = criador.id
...
<div class="container mt-4">
    ...
    <?php if ($result->num_rows > 0): ?>
        <?php while ($row = $result->fetch_assoc()): ?>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div class="d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <span class="badge bg-secondary"><strong>Aluno:</strong> <?= htmlspecialchars($row['nome_aluno_criador']) ?></span>
                    ...
                    <?php if (!empty($row['resposta'])): ?>
                        ...
                        <?php elseif (!empty($row['codigo_avaliacao'])): ?>
                            <!-- Aviso de já avaliado no lugar do botão -->
            ...
            <?php if (!empty($row['resposta']) && $respondente !== 'professor' && empty($row['codigo_avaliacao'])): ?>
                <!-- Modal de Avaliação -->
